...
TEST(VariantSerializerJSONTest, Reading)
{
...
TEST(VariantSerializerJSONTest, Serialization)
{
    const std::string fileName{"TestSerialization.json"};
    ...
    const auto deserialized{Helper::loadVariantAllJSON(fileName)};
