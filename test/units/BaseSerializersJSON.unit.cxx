...
#include "test/helper/files/BaseElementJSON.hxx"
#include "test/helper/structures/StructureBase.hxx"

#include "test/helper/FileManipulation.hxx"

class BaseSerializerJSONTest : public testing::Test
{};

TEST_F(BaseSerializerJSONTest, TestReadingBaseElement)
{
...
TEST_F(BaseSerializerJSONTest, TestWritingBaseElement)
{
    ...
    const auto loadedBase{Helper::loadBaseElementJSON(fileName)};
