...
TEST(AttributesSerializerJSONTest, Deserialize)
{
...
TEST(AttributesSerializerJSONTest, Serialize)
{
    ...
    const auto loadedBase{Helper::loadAttributesElementJSON(fileName)};
